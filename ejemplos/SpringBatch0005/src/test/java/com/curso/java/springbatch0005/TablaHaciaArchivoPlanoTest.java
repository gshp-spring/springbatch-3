package com.curso.java.springbatch0005;
 ...
 * transformar la fila a un objeto Planeta 2.2) crear un FieldSet del objeto
 * Planeta 2.3) guarda ese FieldSet en el archivo planetas-resultado-demo4.txt
